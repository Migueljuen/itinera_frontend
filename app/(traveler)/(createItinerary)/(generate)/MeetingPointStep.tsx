...
const MeetingPointStep: React.FC<MeetingPointStepProps> = ({
    ...
    return (
        <View className="flex-1 bg-white -mx-5 -mt-4">
            {/* Map - Full Screen */}
            <MapView
                ref={mapRef}
                style={{ flex: 1 }}
                ...
                <SafeAreaView edges={['bottom']}>
                    <View className="p-4">
                        ...
                        <View className="flex-row items-start mb-4">
                            ...
                            <View className="ml-3 flex-1">
                                {isLoadingAddress ? (
                                    <View className="flex-row items-center">
                                        <ActivityIndicator size="small" color="#6366F1" />
                                        <Text className="font-onest text-gray-500 ml-2">Finding address...</Text>
                                    </View>
                                ) : selectedLocation ? (
                                    <>
                                        <Text className="font-onest-semibold text-gray-900" numberOfLines={1}>
                                            {selectedLocation.name}
                                        </Text>
                                        <Text className="font-onest text-gray-500 text-sm mt-0.5" numberOfLines={2}>
                        ...
                        <Pressable
                            ...
                            className={`rounded-xl py-4 items-center ${selectedLocation && !isLoadingAddress ? 'bg-primary' : 'bg-gray-300'
                                }`}
                        >
                            <Text className={`font-onest-semibold ${selectedLocation && !isLoadingAddress ? 'text-white' : 'text-gray-500'
                                }`}>
