        ...
        <View className="flex-1 bg-gray-50 px-4 py-6">
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View className="bg-white rounded-xl p-6 mb-4 border border-gray-200">
                    ...
                    {details.conflicting_preferences && details.conflicting_preferences.length > 0 && (
                        <ConflictingPreferencesSection conflicts={details.conflicting_preferences} />
                    )}
                </View>
                ...
                {details.alternative_options && (
                    <>
                        ...
                        {details.alternative_options.nearby_cities?.length > 0 && (
                            <NearbyCitiesSection cities={details.alternative_options.nearby_cities} />
                        )}
