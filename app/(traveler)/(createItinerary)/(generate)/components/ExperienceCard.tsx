// // (createitinerary)/(generate)/components/ExperienceCard.tsx
...
interface ExperienceCardProps {
  ...
  onRemove: () => void;
  travelerCount?: number;
  viewOnly?: boolean; // NEW: When true, hides calendar FAB in experience detail
}
  ...
  const handleCardPress = () => {
    router.push({
      ...
      params: {
        fromItinerary: "true",
        experienceId: item.experience_id,
        viewOnly: viewOnly ? "true" : "false", // NEW: Pass viewOnly param
      },
    });
  };
