                ...
                <View className="flex justify-evenly gap-6 border-t pt-8 border-gray-200">
                    ...
                    {categories.map((category) => {
                      ...
                      return (
                        <View key={category.category_id} className="mt-2">
                          ...
                          <TouchableOpacity
                            activeOpacity={1}
                            className={`p-4 border bg-[#fff] rounded-lg flex-row justify-between items-center relative ${isOpen || hasSelectedTag
                          ...
                          >
                            ...
                            >
                              <View
                                className={`w-5 h-5  border items-center justify-center ${allTagsSelected
                  ...
                  <View className="mb-6">
                    ...
                    {selectedCompanion && selectedCompanion !== "Solo" && (
                      <View className="mt-3 p-4  rounded-xl border border-gray-200">
