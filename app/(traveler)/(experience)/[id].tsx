...
// 9. Main component (much shorter now!)
import { useLocalSearchParams, useRouter } from 'expo-router';
import React from 'react';
import { ActivityIndicator, ScrollView, Text, View } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';

import { ConflictSummary } from '../../../components/itinerary/ConflictSummary';
import { DaySection } from '../../../components/itinerary/DaySection';
import { ItineraryHeader } from '../../../components/itinerary/ItineraryHeader';
import { SaveButton } from '../../../components/itinerary/SaveButton';
import { TimeSlotModal } from '../../../components/itinerary/TimeSlotModal';
import { useItineraryEditor } from '../../../hooks/useItineraryEditor';
import { useTimeSlotModal } from '../../../hooks/useTimeSlotModal';
import { groupItemsByDay } from '../../../utils/itineraryUtils';
...
export default function EditItineraryScreen() {
    ...
    const {
        ...
        updateItem,
        setEditedItems
    } = useItineraryEditor(id as string);

    const timeSlotModal = useTimeSlotModal(
        itinerary,
        editedItems,
        setEditedItems
    );
    ...
    const groupedItems = groupItemsByDay(editedItems);

    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 100 }}>
                <ItineraryHeader itinerary={itinerary} />
                <ConflictSummary items={editedItems} />
                    ...
                    {Object.entries(groupedItems)
                        ...
                        .map(([day, items]) => (
                            <DaySection
                                ...
                                items={items}
                                itinerary={itinerary}
                                allItems={editedItems}
                                onEditTime={timeSlotModal.handleEditTime}
