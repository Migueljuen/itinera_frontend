...
type FloatingActionsProps = {
    ...
    // Optional itinerary context for when viewing from itinerary
    itineraryContext?: ItineraryContext | null;
    // NEW: Hide calendar button entirely (for manual itinerary flow)
    viewOnly?: boolean;
    ...
    return (
        <>
            ...
            >
                ...
                {/* Only show calendar button if allowed */}
                {!viewOnly && !hideCalendar && (
