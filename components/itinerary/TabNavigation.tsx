...
export type TabType = 'overview' | 'guide' | 'tripplan' | 'payment';
...
const TABS: Tab[] = [
    ...
    { key: 'guide', label: 'Guide', iconActive: 'grid', iconInactive: 'grid-outline' },
            ...
            {TABS.map((tab) => {
                ...
                return (
                    <Pressable
                        ...
                        className={`flex-1 flex-row items-center relative  justify-center pb-4 
                            `}
                    >
